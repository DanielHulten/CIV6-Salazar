...
VALUES	('MOMENT_ILLUSTRATION_UNIQUE_UNIT',			'MOMENT_DATA_UNIT',				'UNIT_PORTUGUESE_NAU',				'MomentSTK_Nau.dds'		),
		('MOMENT_ILLUSTRATION_UNIQUE_IMPROVEMENT',	'MOMENT_DATA_IMPROVEMENT',		'IMPROVEMENT_FEITORIA',				'MomentSTK_Feitoria.dds'	),
		('MOMENT_ILLUSTRATION_UNIQUE_IMPROVEMENT',	'MOMENT_DATA_BUILDING',			'BUILDING_NAVIGATION_SCHOOL',		'MomentSTK_NavigationSchool.dds'	);
