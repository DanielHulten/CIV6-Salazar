...
VALUES		('CIVILIZATION_DH_PORTUGAL',		'LEADER_MC_PO_NGBE',	'LOC_CITY_NAME_DH_PORTUGAL_1'	);
...
VALUES		('CIVILIZATION_DH_PORTUGAL',		'LEADER_MC_PO_NGBE',	-1,			'LOC_CITY_NAME_DH_PORTUGAL_1'		),
			('CIVILIZATION_DH_PORTUGAL',		'LEADER_MC_PO_NGBE',	-1,			'LOC_CITY_NAME_DH_PORTUGAL_2'		),
			('CIVILIZATION_DH_PORTUGAL',		'LEADER_MC_PO_NGBE',	-1,			'LOC_CITY_NAME_DH_PORTUGAL_3'		),
			('CIVILIZATION_DH_PORTUGAL',		'LEADER_MC_PO_NGBE',	-1,			'LOC_CITY_NAME_DH_PORTUGAL_4'		),
			('CIVILIZATION_DH_PORTUGAL',		'LEADER_MC_PO_NGBE',	-1,			'LOC_CITY_NAME_DH_PORTUGAL_5'		),
			('CIVILIZATION_DH_PORTUGAL',		'LEADER_MC_PO_NGBE',	-1,			'LOC_CITY_NAME_DH_PORTUGAL_6'		),
			('CIVILIZATION_DH_PORTUGAL',		'LEADER_MC_PO_NGBE',	-1,			'LOC_CITY_NAME_DH_PORTUGAL_7'		),
			('CIVILIZATION_DH_PORTUGAL',		'LEADER_MC_PO_NGBE',	-1,			'LOC_CITY_NAME_DH_PORTUGAL_8'		),
			('CIVILIZATION_DH_PORTUGAL',		'LEADER_MC_PO_NGBE',	-1,			'LOC_CITY_NAME_DH_PORTUGAL_9'		),
			('CIVILIZATION_DH_PORTUGAL',		'LEADER_MC_PO_NGBE',	-1,			'LOC_CITY_NAME_DH_PORTUGAL_10'		),
			('CIVILIZATION_DH_PORTUGAL',		'LEADER_MC_PO_NGBE',	-1,			'LOC_CITY_NAME_DH_PORTUGAL_11'		),
			('CIVILIZATION_DH_PORTUGAL',		'LEADER_MC_PO_NGBE',	-1,			'LOC_CITY_NAME_DH_PORTUGAL_12'		),
			('CIVILIZATION_DH_PORTUGAL',		'LEADER_MC_PO_NGBE',	-1,			'LOC_CITY_NAME_DH_PORTUGAL_13'		),
			('CIVILIZATION_DH_PORTUGAL',		'LEADER_MC_PO_NGBE',	-1,			'LOC_CITY_NAME_DH_PORTUGAL_14'		),
			('CIVILIZATION_DH_PORTUGAL',		'LEADER_MC_PO_NGBE',	-1,			'LOC_CITY_NAME_DH_PORTUGAL_15'		);
